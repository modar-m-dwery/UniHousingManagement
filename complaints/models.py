...
class Complaint(models.Model):
    ...
    # إذا كان المستخدم لديه إذن لتحرير الشكوى
    def can_edit(self, user):
        if user.is_official and user.official.is_chief():
            return True
        # مقدم الشكوى ليس طالبًا ، ويتطابق الحظر المرتبط بالكيان مع حظر المستخدم الرسمي.
        # يتطابق الحظر المرتبط بتفاصيل غرفة كيان مقدم الشكوى مع كتلة المستخدم الرسمي.
        # يضمن هذا المنطق أن المسؤولين يمكنهم فقط تحرير الشكاوى ذات الصلة بالكيانات أو الكيانات المخصصة لهم.
