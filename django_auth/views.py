...
def account_activate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        # يقوم بتعيين بيانات الجلسة اللازمة لتذكر حالة تسجيل دخول المستخدم.
        # لا تقوم وظيفة تسجيل الدخول (الطلب ، المستخدم) بإرجاع أي قيمة ، لأنها تعدل جلسة المستخدم لتسجيل الدخول
        login(request, user)
